...
module.exports = {
    ...
    onStart: async function ({ message, args }) {
        ...
        try {
            ...
            const response = await axios.get(`https://aminulzisan.com/ask?question=${encodeURIComponent(question)}`);
            ...
            if (response.data && response.data.reply) {
                ...
                await message.reply("⚠️ Could not get a reply from the API. Please try again later.");
            }
        } catch (error) {
