...
module.exports = {
	config: {
		...
		shortDescription: {
			vi: "",
			en: "play tic tac toe with friends"
		},
		category: "game",
		guide: "",
...
message.send(global.game[event.threadID].board)
    ...
    if(global.game[event.threadID].turn === global.game[event.threadID].player1.id){
      setTimeout(function(){message.send({body:`Damn ${global.game[event.threadID].player1.name} bro is the winner`, mentions: [{
                        tag: global.game[event.threadID].player1.name,
                        id: global.game[event.threadID].player1.id,
    ...
    }, 1000)} else {setTimeout(function(){message.send({body:`Damn ${global.game[event.threadID].player2.name} bro is the winner`, mentions: [{
                        tag: global.game[event.threadID].player2.name,
                        id: global.game[event.threadID].player2.id,
