...
module.exports = {
    ...
    langs: {
        vi: {
            ...
            session3: "chiều",
            session4: "tối",
            welcomeMessage: "Cảm ơn bạn đã mời tôi vào nhóm!nPrefix bot: %1nĐể xem danh sách lệnh hãy nhập: %1help",
            multiple1: "bạn",
            multiple2: "các bạn",
            defaultWelcomeMessage: "Xin chào {userName}.nChào mừng bạn đến với {boxName}.nChúc bạn có buổi {session} vui vẻ!",
            approvalMessage: "Hi, I'm Nezuko bot. Thanks for adding me to the groupnnBut you need approval to use the bot.nPlease contact the admin nn? m.me/JISHAN76nn I have to leave the chat now. Thank you!"
        },
        en: {
            session1: "morning",
            session2: "noon",
            ...
            multiple1: "you",
            multiple2: "you guys",
            defaultWelcomeMessage: `thank you for adding me againnhave a nice chat ?`,
            approvalMessage: "Hi, I'm Nezuko bot. Thanks for adding me to the groupnnBut you need approval to use the bot.nPlease contact the admin nn? m.me/JISHAN76nn I have to leave the chat now. Thank you!"
        }
    },
